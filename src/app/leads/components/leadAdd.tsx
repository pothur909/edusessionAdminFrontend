...
//     if (name === 'subjects') {
//       // for multiple subjects as comma separated string (or can use checkboxes)
...
//     // class: required (no enum given, so just check presence)
//     if (!formData.class) {
...
//     const leadSources = ['website', 'referral', 'social_media', 'other'];
//     if (!formData.leadSource) {
//       newErrors.leadSource = 'Lead source is required';
//     } else if (!leadSources.includes(formData.leadSource)) {
//       newErrors.leadSource = `Lead source must be one of: ${leadSources.join(', ')}`;
//     }
...
//     const modes = ['phone', 'whatsapp', 'email'];
//     if (!formData.modeOfContact) {
//       newErrors.modeOfContact = 'Mode of contact is required';
//     } else if (!modes.includes(formData.modeOfContact)) {
//       newErrors.modeOfContact = `Mode of contact must be one of: ${modes.join(', ')}`;
//     }
...
//     // if(formData.preferredTimeSlots){
//     //   const date= new Date(formData.preferredTimeSlots);
//     //   if(isNaN(date.getTime())){
//     //     newErrors.preferredTimeSlots= 'Invalid preferred Time end date'
//     //   }
//     // }

//     // remarks and notes: optional (no validation needed)
